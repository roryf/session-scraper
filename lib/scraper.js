...
Scraper.prototype.force = {};
Scraper.prototype.force.get = function (url) {
    return (this.oldPerformRequest || this.performRequest)({
        url: url,
        method: 'GET'
    });
};
Scraper.prototype.force.post = function (url, body) {
    return (this.oldPerformRequest || this.performRequest)({
        url: url,
        method: 'POST',
        form: body
...
Scraper.prototype.performRequest = function (options) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        request(options, function (err, response, body) {
            ...
            var $ = cheerio.load(self.encodingFn ? self.encodingFn(body) : body);
            $.body = body;
            $.response = response;
            resolve($);
        });
